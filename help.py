...
red_pos = pygame.Vector2(int(screen.get_width()-red_size), (screen.get_height()-red_size))
red_vel = pygame.Vector2(0, 0)
green_pos = pygame.Vector2((screen.get_width()-(green_size+red_size)), (screen.get_height()-(green_size+red_size)))
green_vel = pygame.Vector2(0, 0)
yellow_pos = pygame.Vector2((screen.get_width()-(yellow_size+green_size+red_size)), screen.get_height()-(yellow_size+green_size+red_size))
...
while running:
    ...
    if red_pos.y > screen.get_height() - red_size:
        ...
        red_vel.y *= -1  # Invert vertical velocity to bounce back
    if red_pos.y < red_size:
        red_pos.y = red_size
        red_vel.y *= -1
    if red_pos.x > screen.get_width() - red_size:
        red_pos.x = screen.get_width() - red_size
        red_vel.x *= -1  # Invert horizontal velocity to bounce back
    ...
    if green_pos.y > screen.get_height() - green_size:
        ...
        green_vel.y *= -1  # Invert vertical velocity to bounce back
    ...
    if green_pos.x > screen.get_width() - green_size:
        ...
        green_vel.x *= -1  # Invert horizontal velocity to bounce back
    ...
    if yellow_pos.y > screen.get_height() - yellow_size:
        ...
        yellow_vel.y *= -1  # Invert vertical velocity to bounce back
    ...
    if yellow_pos.x > screen.get_width() - yellow_size:
        ...
        yellow_vel.x *= -1  # Invert horizontal velocity to bounce back
